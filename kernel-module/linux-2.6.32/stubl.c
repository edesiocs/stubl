 ...
 *
 * Note: This module has not been tested with multiple network namespaces.
 *
 * Authors:
...
static int __init sit_init(void)
{
	...
	// This could probably go in the .ndo_init field of ipip6_netdev_ops,
	// but this way is more consistent with sit.c.
	ipip6_fb_tunnel_init(ipip6_fb_tunnel_dev);
